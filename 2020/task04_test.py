...
class TestTask(TestCase):
    def test_validate_fields(self):
        ...
        self.assertTrue(all(validate_fields(p) for p in valid_passports))
        invalid_passwords = [
        ...
        self.assertFalse(any(validate_fields(p) for p in invalid_passwords))
    ...
    def test_validators(self):
        ...
        self.assertTrue(validators["ecl"]("brn"))
        self.assertFalse(validators["ecl"]("wat"))
    ...
    def test_validate_strict(self):
        ...
        self.assertFalse(any(validate_strict(passport) for passport in invalid))
        ...
        self.assertTrue((validate_strict(passport) for passport in valid))
